...
const rankC = [
  ...
  { rank:36, name:"Fabiane Lamboia",         pts:200  },
  { rank:36, name:"Flavia Hass",             pts:200  },
  { rank:36, name:"Katiuza Brasil",          pts:200  },
  { rank:36, name:"Nilshely",                pts:200  },
  { rank:41, name:"Fernanda Escobar",        pts:150  },
  { rank:41, name:"Geovana Machado",         pts:150  },
  { rank:41, name:"Monica Bora",             pts:150  },
  { rank:44, name:"Amanda Nogueira",         pts:100  },
  { rank:44, name:"Fabiana Zapzalka",        pts:100  },
  { rank:44, name:"Karla Cunha",             pts:100  },
  { rank:44, name:"Kelly Ribeiro",           pts:100  },
  { rank:44, name:"Maureen Colombo",         pts:100  },
  { rank:44, name:"Mylla Murta",             pts:100  },
  { rank:44, name:"Rebecca",                 pts:100  },
  { rank:44, name:"Rosangela Pretko",        pts:100  },
  { rank:52, name:"Adriana Zaithammer",      pts:50   },
  { rank:52, name:"Aghata Wuicik",           pts:50   },
  { rank:52, name:"Aline Henz",              pts:50   },
  { rank:52, name:"Ana Cristina Pretto",     pts:50   },
  { rank:52, name:"Ana Paula Constantino",   pts:50   },
  { rank:52, name:"Ana V Rigolino",          pts:50   },
  { rank:52, name:"Arizla Fernandes",        pts:50   },
  { rank:52, name:"Barbara Luvison",         pts:50   },
  { rank:52, name:"Bianca Behrens",          pts:50   },
  { rank:52, name:"Bianca Belotti",          pts:50   },
  { rank:52, name:"Bruna Naday",             pts:50   },
  { rank:52, name:"Caroline Pasinato",       pts:50   },
  { rank:52, name:"Dani Borba",              pts:50   },
  { rank:52, name:"Danielle Konrad",         pts:50   },
  { rank:52, name:"Danile Lima",             pts:50   },
  { rank:52, name:"Deny Segantini",          pts:50   },
  { rank:52, name:"Fernanda Gusso",          pts:50   },
  { rank:52, name:"Fernanda Risnei",         pts:50   },
  { rank:52, name:"Gilmara Coronado",        pts:50   },
  { rank:52, name:"Juliana Fukushima",       pts:50   },
  { rank:52, name:"Karina Menegusso",        pts:50   },
  { rank:52, name:"Kelen Ribeiro",           pts:50   },
  { rank:52, name:"Leticia Girata",          pts:50   },
  { rank:52, name:"Leticia Kawata",          pts:50   },
  { rank:52, name:"Lucianna Wieler",         pts:50   },
  { rank:52, name:"Marcia Nonnenmacher",     pts:50   },
  { rank:52, name:"Mayra Favoretto",         pts:50   },
  { rank:52, name:"Pathy Valerio",           pts:50   },
  { rank:52, name:"Patricia Farracha",       pts:50   },
  { rank:52, name:"Pri Melo",                pts:50   },
  { rank:52, name:"Rafaella Krelling",       pts:50   },
  { rank:52, name:"Samantha Cim",            pts:50   },
  { rank:52, name:"Sandra Evelizi",          pts:50   },
  { rank:52, name:"Silvia Schneider",        pts:50   },
  { rank:52, name:"Tatiane Belotti",         pts:50   },
  { rank:52, name:"Valery Riechi",           pts:50   },
  { rank:52, name:"Vanessa Leandro",         pts:50   },
  { rank:52, name:"Vanessa Schultz",         pts:50   },
];

const rankD = [
  { rank:1, name:"Fernanda Lima",   pts:1620 },
  { rank:2, name:"Simone Ramos",    pts:1430 },
  { rank:3, name:"Carla Teixeira",  pts:1250 },
  { rank:4, name:"Bruna Nogueira",  pts:1080 },
  { rank:5, name:"Tatiane Souza",   pts:940  },
  { rank:6, name:"Patricia Vieira", pts:810  },
  { rank:7, name:"Juliana Farias",  pts:680  },
  { rank:8, name:"Monica Braz",     pts:520  },
];
