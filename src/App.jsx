...
const rankC = [
  ...
  { rank:29, name:"Fernanda Moreschi", pts:500 },
  { rank:29, name:"Milena Mayer", pts:500 },
  { rank:29, name:"Vanessa Thomaz", pts:500 },
  { rank:32, name:"Fabiana Nunes", pts:450 },
  { rank:32, name:"Maira Daros", pts:450 },
  { rank:32, name:"Silvia Schneider", pts:450 },
  { rank:35, name:"Paula Ferreira", pts:400 },
  { rank:36, name:"Aline Gaensly", pts:350 },
  { rank:36, name:"Ana Carla M Rodrigues", pts:350 },
  { rank:36, name:"Lorena Cortiani", pts:350 },
  { rank:36, name:"Martina Hffrichter", pts:350 },
  { rank:36, name:"Renata Suchek", pts:350 },
  { rank:41, name:"Ana Murbach", pts:250 },
  { rank:41, name:"Elaine Maiorki", pts:250 },
  { rank:41, name:"Fabiany Lamboia", pts:250 },
  { rank:41, name:"Katia Gomes", pts:250 },
  { rank:41, name:"Sandra Evelizi", pts:250 },
  { rank:46, name:"Danielle Sale", pts:200 },
  { rank:46, name:"Dina Santana", pts:200 },
  { rank:46, name:"Flavia Hass", pts:200 },
  { rank:46, name:"Isabela Rodrigues", pts:200 },
  { rank:46, name:"Karla Cunha", pts:200 },
  { rank:46, name:"Katiuza Brasil", pts:200 },
  { rank:46, name:"Maria Luisa Lincher (Malu)", pts:200 },
  { rank:46, name:"Mauren Colombo", pts:200 },
  { rank:46, name:"Nilshely", pts:200 },
  { rank:55, name:"Dani Borba", pts:150 },
  { rank:55, name:"Geovana Machado", pts:150 },
  { rank:55, name:"Monica Bora", pts:150 },
  { rank:58, name:"Amanda Nogueira", pts:100 },
  { rank:58, name:"Ana V Rigolino", pts:100 },
  { rank:58, name:"Barbara Luvison", pts:100 },
  { rank:58, name:"Fabiana Zapzalka", pts:100 },
  { rank:58, name:"Fernanda Gusso", pts:100 },
  { rank:58, name:"Kelen Ribeiro", pts:100 },
  { rank:58, name:"Kelly Ribeiro", pts:100 },
  { rank:58, name:"Leticia Girata", pts:100 },
  { rank:58, name:"Mylla Murta", pts:100 },
  { rank:58, name:"Rebecca", pts:100 },
  { rank:58, name:"Rosangela Pretko", pts:100 },
  { rank:58, name:"Vanessa Schultz", pts:100 },
  { rank:70, name:"Adriana Zaithammer", pts:50 },
  { rank:70, name:"Aghata Wuicik", pts:50 },
  { rank:70, name:"Alice Losso", pts:50 },
  { rank:70, name:"Alicia Moss", pts:50 },
  { rank:70, name:"Aline Henz", pts:50 },
  { rank:70, name:"Ana Cristina Pretto", pts:50 },
  { rank:70, name:"Ana Paula Constantino", pts:50 },
  { rank:70, name:"Arizla Fernandes", pts:50 },
  { rank:70, name:"Bianca Behrens", pts:50 },
  { rank:70, name:"Bianca Belotti", pts:50 },
  { rank:70, name:"Bruna Naday", pts:50 },
  { rank:70, name:"Camila Almeida", pts:50 },
  { rank:70, name:"Danielle Konrad", pts:50 },
  { rank:70, name:"Danile Lima", pts:50 },
  { rank:70, name:"Deny Segantini", pts:50 },
  { rank:70, name:"Fernanda Risnei", pts:50 },
  { rank:70, name:"Gilmara Coronado", pts:50 },
  { rank:70, name:"Giselle Duarte", pts:50 },
  { rank:70, name:"Joelly Michelle", pts:50 },
  { rank:70, name:"Juliana Fukushima", pts:50 },
  { rank:70, name:"Kamile Enzo", pts:50 },
  { rank:70, name:"Karina Menegusso", pts:50 },
  { rank:70, name:"Karine Duarte", pts:50 },
  { rank:70, name:"Leidi Brancher", pts:50 },
  { rank:70, name:"Leila Caetano", pts:50 },
  { rank:70, name:"Leticia Kawata", pts:50 },
  { rank:70, name:"Lucianna Wieler", pts:50 },
  { rank:70, name:"Marcia Nonnenmacher", pts:50 },
  { rank:70, name:"Maria Claudia Rebelato", pts:50 },
  { rank:70, name:"Maria Emilia Staczuk", pts:50 },
  { rank:70, name:"Mariane Salvalaggio", pts:50 },
  { rank:70, name:"Mayra Favoretto", pts:50 },
  { rank:70, name:"Pathy Valerio", pts:50 },
  { rank:70, name:"Patrica Farracha", pts:50 },
  { rank:70, name:"Pri  Melo", pts:50 },
  { rank:70, name:"Rafaella Krelling", pts:50 },
  { rank:70, name:"Renata Emy Kuradomi", pts:50 },
  { rank:70, name:"Samantha Cim", pts:50 },
  { rank:70, name:"Sara Vdal", pts:50 },
  { rank:70, name:"Tatiane Balbinotti", pts:50 },
  { rank:70, name:"Tatiane Belotti", pts:50 },
  { rank:70, name:"Thais Wabesky", pts:50 },
  { rank:70, name:"Valery Riechi", pts:50 },
  { rank:70, name:"Vanessa Leandro", pts:50 },
];
...
// ─── LINKS DOS PDFs ──────────────────────────────────────────────
const pdfLinks = {
  C: "https://drive.google.com/file/d/14f9auwZmIOwVNERQDaOrk95SG_2vkG-D/view?usp=drive_link",
